...
class TestCases(unittest.TestCase):
    ...
    def test_sphere_interestion_points_4(self):
        sphere1 = data.sphere(data.point(1.0, 1.0, 0.0), 2)
        sphere2 = data.sphere(data.point(0.5, 1.5, -3), 0.5)
        eye_point = data.point(0, 0, -14)
        grid_point = data.point(1.0545875, 1.484375, 0)
        ray_dir = vector_math.vector_from_to(eye_point, grid_point)
        ray = data.ray(eye_point, ray_dir)
        self.assertTrue(cast.cast_ray(ray, [sphere1, sphere2]))
