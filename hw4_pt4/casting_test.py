...
small_sphere = data.sphere(data.point(0.5, 1.5, -3.0), 0.5, data.color(1, 0, 0), data.finish(0.4, 0.4))
big_sphere = data.sphere(data.point(1.0, 1.0, 0.0), 2, data.color(0, 0, 1), data.finish(0.2, 0.4))
